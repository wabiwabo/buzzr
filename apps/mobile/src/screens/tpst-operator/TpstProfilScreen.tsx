...
export default function TpstProfilScreen() {
  ...
  const verifiedCount = manifests.filter(
  ...
  return (
    ...
    >
      ...
      <View style={styles.profileHeader}>
        ...
        <Text style={styles.userName}>{user?.name || 'Operator TPST'}</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statsCard}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>Total Manifest</Text>
          </View>
        </View>
      </View>
